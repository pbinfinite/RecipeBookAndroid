...
import com.example.recipebook_1.DatabaseHelper;
import com.example.recipebook_1.R;
...
public class AddRecordActivity extends AppCompatActivity {
    ...
    private String title, ingredients, steps, timeStamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pSaveInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressRound.setVisibility(View.GONE);
                Toast.makeText(AddRecordActivity.this, "Added Successfully", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void getData() {
        ...
        if(!title.equals("") && !ingredients.equals("") && !steps.equals("") && !imageUri.toString().equals("")) {
        ...
        else if(imageUri.toString().equals("")){
            Toast.makeText(AddRecordActivity.this, "Add Image", Toast.LENGTH_LONG).show();
        }
        else if(title.equals("")){
            Toast.makeText(AddRecordActivity.this, "Add Title", Toast.LENGTH_LONG).show();
        }
        else if(ingredients.equals("")){
            Toast.makeText(AddRecordActivity.this, "Add Ingredients", Toast.LENGTH_LONG).show();
        }
        else if(steps.equals("")){
            Toast.makeText(AddRecordActivity.this, "Add Instructions", Toast.LENGTH_LONG).show();
        }
    }
